...
for i in range(args.n_runs):
    ...
    for epoch in range(NUM_EPOCH):
        ...
        # Training phase
        if USE_MEMORY:
            netmodel.memory.__init_memory__()  # Re-initialize memory at the start of each epoch
        
        netmodel.set_neighbor_finder(train_ngh_finder)  # Set neighbor finder for training
