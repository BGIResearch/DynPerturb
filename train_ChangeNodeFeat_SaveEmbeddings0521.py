...
# from utils.data_processing0208 import  get_data, get_and_change_data, compute_time_statistics
...
os.chdir("/home/share/huadjyin/home/s_qinhua2/02code/netmodel-master/human_bone/") 
torch.manual_seed(0)
np.random.seed(0)
...
parser.add_argument('--memory_dim', type=int, default=1000, help='Dimensions of the memory for '
                                                                'each user')
parser.add_argument('--num_classes', type=int, default=8, help='class num')
...
# **加载已经训练好的模型**
MODEL_SAVE_PATH = f'/home/share/huadjyin/home/s_qinhua2/02code/netmodel-master/human_bone/saved_models/humanbone_F1_usememory_fullneighbor-HumanBone  node-classification.pth'
# MODEL_SAVE_PATH = f'/home/share/huadjyin/home/s_qinhua2/02code/netmodel-master/spatiotemporal_mouse/saved_models/mouse_spatial-mouse_spatial  node-classification.pth'
